...
public class PlanetAdapter extends RecyclerView.Adapter<PlanetAdapter.PlanetHolder> {
    //PlanetHolder class is a viewHolder class
    public class PlanetHolder extends RecyclerView.ViewHolder {
        ...
        // Creating a method in PlanetHolder class for set values for each planet to item row.
    ...
    //calling the setDetails method (from class PlanetHolder
    @Override
